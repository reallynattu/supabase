...
Use this when the surrounding layout is a card or full-page panel. For sheet contexts (slide-over drawers), use [Collapsible Form Section](./collapsible-form-section) instead.
